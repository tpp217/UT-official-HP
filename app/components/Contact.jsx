    ...
    <section id="contact" style={{
      ...
      <div className="wrap" style={{ position: 'relative' }}>
        <div className="reveal" style={{ marginBottom: 40 }}>
          ...
          <p style={{
            marginTop: 20, maxWidth: 560, fontSize: 'clamp(15px,1.2vw,16px)',
            lineHeight: 1.85,
          }}>
            30分のオンライン相談は無料です。
            具体的な要件が決まっていなくても大丈夫。
          ...
          {status === 'success' ? (
            ...
            >
              ...
              <div style={{
                ...
                <div className="field">
                  <label>お名前 *</label>
                  <input name="name" required placeholder="山田 太郎" disabled={status === 'sending'} />
                </div>
                <div className="field">
                  <label>メール *</label>
                  <input name="email" type="email" required placeholder="you@company.com" disabled={status === 'sending'} />
                </div>
                <div className="field">
                  <label>電話 (任意)</label>
