        ...
        <div className="reveal" style={{
          ...
          <div>
            ...
            <h2 className="section">
              やること、<br />
              <span style={{
                background: 'var(--mint)', padding: '0 0.14em', borderRadius: 8,
        ...
        <div style={{
          ...
          {data.map((d, i) => (
            <article key={d.n} className="nb-card reveal" style={{
              ...
              <h3 style={{
                margin: '18px 0 10px', fontSize: 'clamp(20px,2vw,26px)',
                fontWeight: 900, letterSpacing: '-0.02em', lineHeight: 1.2,
              }}>
                {d.title}
              </h3>
              <p style={{ margin: 0, fontSize: 14, lineHeight: 1.75, opacity: 0.9 }}>
                {d.body}
              </p>
