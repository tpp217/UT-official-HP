// Voice — testimonials, colorful speech-bubble cards
function Voice(){
  const vs = [
        ...
        <div style={{display:'grid',gap:18,
          ...
          {vs.map((v,i)=>(
            <figure key={v.n} className="nb-card reveal" style={{
              ...
              <div style={{fontFamily:'"Archivo Black",sans-serif',fontSize:64,
                lineHeight:0.8,marginBottom:6}}>
                “
              </div>
              <blockquote style={{margin:0,fontSize:'clamp(15px,1.3vw,17px)',
                lineHeight:1.75,fontWeight:500}}>
                {v.quote}
              </blockquote>
              <figcaption style={{marginTop:22,paddingTop:14,
                ...
                <div>
                  ...
                  <div style={{fontSize:11,opacity:.75,marginTop:2,
                    fontFamily:'"Space Mono",monospace'}}>{v.role}</div>
                </div>
              </figcaption>
            </figure>
          ))}
